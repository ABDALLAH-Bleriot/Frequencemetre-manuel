...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var rbDrops: RadioButton
    private lateinit var rbHeart: RadioButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rbDrops = findViewById(R.id.rbDrops)
        ...
        rgMode.setOnCheckedChangeListener { _, _ -> updateUnitLabel() }
